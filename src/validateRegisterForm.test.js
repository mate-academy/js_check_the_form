...
describe(`Function 'validateRegisterForm':`, () => {
  ...
  it(`should return error for valid password and email without '@'`, () => {
    const invalidPassword = validateRegisterForm('testmail.com', 'Pa!sword1');
  ...
  it(`should return error for valid emailand password with 
  17 charachters`, () => {
  ...
  it(`should return error for valid emailand password without 
  special character`, () => {
    const invalidPassword = validateRegisterForm('test@mail.com', 'Paasswoord');
  ...
  it(`should return success message for the valid email and password 
  ...
  it(`should return error for valid password and email which personal_info
  part start with dot`, () => {
    const invalidPassword = validateRegisterForm('.test@mail.com', 'P@ssword1');
  ...
  it(`should return error for valid password and email domain start 
  with dot`, () => {
    const invalidPassword = validateRegisterForm('test@.mail.com', 'P@ssword1');
  ...
  it(`should return error for valid password and mail containing 
  a space`, () => {
  ...
  it(`should return success message valid password and email which includes
  these characters:'! $ % & ' * + / = ? ^ { | } ~'`, () => {
