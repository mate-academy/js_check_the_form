...
describe(`Function 'validateRegisterForm':`, () => {
  ...
  it(`should return error for valid email,
    ...
    const invalidPassword
     = validateRegisterForm('test123@mail.com', 'Password1');
  ...
  it(`should return error for valid email,
    but password without at
    least 1 uppercase character`, () => {
    const invalidPassword
    = validateRegisterForm('test123@mail.com', 'p@ssword1');
  ...
  it(`should return error for valid email and password,
    ...
    const invalidPassword
    = validateRegisterForm('test123@mail.com', 'P@ssword123456789');
  ...
  it(`should return success message for valid
    ...
    const isValid
     = validateRegisterForm('test123@mail.com', 'P@sswor1');

    expect(isValid.code).toBe(200);
    expect(isValid.message).toBe('Email and password are valid.');
  });

  it(`should return success message valid email and password,
    but password length 16`, () => {
    const isValid
     = validateRegisterForm('test123@mail.com', 'Password@2345678');
  ...
  it(`should return success message for valid email
    ...
    const isValid
     = validateRegisterForm('test123@mail.com', 'ПарольPass#12');
  ...
  it(`should return error for valid password,
    ...
    const invalidEmail
     = validateRegisterForm('Тестtest12@mail.com', 'P@ssword12!');
  ...
  it(`should return error for valid password,
    ...
    const invalidEmail
     = validateRegisterForm('Тестtest12@mail', 'P@ssword12!');
  ...
  it(`should return error for valid password,
    ...
    const invalidEmail
     = validateRegisterForm('.test12@mail.com', 'P@ssword12!');
  ...
  it(`should return error for valid password,
    ...
    const invalidEmail
     = validateRegisterForm('t..est12@mail.com', 'P@ssword12!');
  ...
  it(`should return error for valid password,
   but email with no '@' symbol`, () => {
    const invalidEmail
     = validateRegisterForm('test12mail.com', 'P@ssword12!');
  ...
  it(`should return error for invalid password and invalid email`, () => {
    const invalidBoth
     = validateRegisterForm('tes..t12@mail.com.', 'password');
